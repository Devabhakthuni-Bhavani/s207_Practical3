pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://13.62.20.171:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Devabhakthuni-Bhavani/s207_Practical3.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://13.62.20.171:9090/springapp1"
            echo "✅ Frontend deployed: http://13.62.20.171:9090/frontapp1"
        }
        failure {
